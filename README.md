...
- Lectura-->[API design for machine learning software:experiences from the scikit-learn project](https://github.com/C-Lara/Curso-CM072/blob/master/Introducci%C3%B3n/API-ScikitLearn.pdf).
